...
add_shortcode('qod', 'welovequotes_quote_of_the_day');
add_shortcode('rquote', 'welovequotes_random_quote');
...
?>
    <div class="notice notice-success is-dismissible">
        <p><?php printf( esc_html__( '%s', 'my-plugin-textdomain' ),  get_quote(rand(0, 365))); ?></p>
    </div>
<?php
}
